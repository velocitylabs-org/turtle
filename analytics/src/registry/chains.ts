...
export const AssetHub: Chain = {
  ...
  rpcConnection: `wss://api-asset-hub-polkadot.dwellir.com`,
}
...
export const RelayChain: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-polkadot.n.dwellir.com`,
}
...
export const BridgeHub: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-bridge-hub-polkadot.dwellir.com`,
}
...
export const Bifrost: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-bifrost-polkadot.dwellir.com`,
}
...
export const Hydration: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-hydradx.dwellir.com`,
}
...
export const Phala: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-phala.dwellir.com`,
}
...
export const Moonbeam: Chain = {
  ...
  supportedAddressTypes: ['evm'],
  walletType: 'EVM',
  rpcConnection: `wss://api-moonbeam.n.dwellir.com`,
}
...
export const Interlay: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-interlay.dwellir.com`,
}
...
export const Acala: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-acala.dwellir.com`,
}
...
export const Polimec: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-polimec.n.dwellir.com`,
}
...
export const Centrifuge: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-centrifuge.dwellir.com`,
}
...
export const Astar: Chain = {
  ...
  supportedAddressTypes: ['ss58'],
  walletType: 'Substrate',
  rpcConnection: `wss://api-astar.dwellir.com`,
}
