...
export const TabSwitcherWrapper = ({ TransferComponent, BuySellComponent }: TabSwitcherWrapperProps) => {
  ...
  return (
    <div>
      <div className="relative flex flex-col rounded-t-3xl border border-b-0 border-turtle-foreground bg-turtle-level1 p-6 sm:p-10 sm:pb-4 w-full max-w-[90vw] sm:w-[31.5rem]">
        <div className="flex">
