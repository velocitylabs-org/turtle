...
const HistoryLoaderSkeleton = ({ length }: { length: number }) => {
  return (
    <div className="z-20 flex max-h-[70vh] max-w-[90vw] flex-col gap-1 overflow-auto rounded-2xl border bg-background p-5 px-[1.5rem] py-[2rem] sm:w-[31.5rem] sm:p-[2.5rem]">
