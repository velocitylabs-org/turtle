...
export function getTransferStatus(transferResult: TxTrackingResult) {
  ...
  if (isAhToEthTransfer) return getTransferStatusFromParachain(transferResult as FromParaToEthTrackingResult)
 ...
 * @returns - the transfer status
 */
function getTransferStatusFromParachain(transferResult: FromParaToEthTrackingResult | FromParachainTrackingResult) {
