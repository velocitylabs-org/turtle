export default function Credits() {
  return (
    <div className="credits rainbow-text mt-6 flex flex-col text-center text-xs tracking-normal">
      <div>
        Made with love by{' '}
      ...
      <div className="mt-1">
        ...
        {', '}
        <a href="https://chainflip.io/" target="_blank" rel="noopener noreferrer">
          Chainflip
        </a>
        {' & '}
        <a href="https://www.meld.io/" target="_blank" rel="noopener noreferrer">
          Meld.io
        </a>
      </div>
    </div>
