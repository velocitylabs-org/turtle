...
const Widget = dynamic(() => import('@velocitylabs-org/turtle-widget'), {
  ssr: false,
  loading: () => (
    <div className="widget-loader flex h-[300px] w-full flex-col items-center justify-center rounded-3xl bg-white md:h-[460px] md:w-[504px]">
