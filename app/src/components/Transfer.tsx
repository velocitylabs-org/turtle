...
const Transfer: FC = () => {
  ...
  return (
    <form
      ...
      className="z-20 flex flex-col gap-1 rounded-3xl bg-white p-5 shadow-lg backdrop-blur-sm sm:w-[31.5rem] px-[1.25rem] py-[2rem] sm:p-[2.5rem]"
    >
      ...
      />
       ...
       {/* Credits */}
      <div className="flex flex-row justify-center mt-6 credits text-sm text-turtle-level5">
        Made with love by {' '} 
