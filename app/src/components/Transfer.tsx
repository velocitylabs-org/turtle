...
export default function Transfer() {
  ...
  return (
    <form
      ...
      className="z-20 flex w-[100vw] max-w-[90vw] flex-col gap-1 rounded-b-3xl border border-t-0 border-turtle-foreground bg-white p-5 px-[1.5rem] py-[2rem] sm:w-[31.5rem] sm:p-[2.5rem]"
    >
