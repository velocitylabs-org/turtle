...
export default function Transfer() {
  ...
  return (
    <form
      ...
      className="flex w-full max-w-[90vw] max-h-[60vh] flex-col gap-1 rounded-b-3xl border border-t-0 border-turtle-foreground bg-white p-5 px-[1.5rem] py-[2rem] sm:w-[31.5rem] sm:p-[2.5rem]"
    >
