...
const useFees = (
  ...
  const [feesTokenSufficient, setFeesTokenSufficient] = useState<boolean>(true)
    ...
    try {
      ...
      switch (direction) {
        ...
        case Direction.WithinPolkadot: {
          ...
          setFeesTokenSufficient(info.sufficientForXCM)
          break
        }
  ...
  return { fees, loading, refetch: fetchFees, feesTokenSufficient }
}
